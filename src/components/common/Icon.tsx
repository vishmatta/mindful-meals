...
const ICONS: { [key: string]: React.ReactElement } = {
  ...
  loading: <path d="M12 2a10 10 0 1 0 10 10" strokeLinecap="round" strokeLinejoin="round" />,
  ...
  refresh: <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5m11 2a9 9 0 11-2-6.327" />,
